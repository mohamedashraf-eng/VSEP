...
#define BTL_FIRMWARE_SIZE					(24u * STM32F103C8Tx_FLASH_PAGE_SIZE)
#define BTL_FIRMWARE_START_ADDRESS			(FLASH_BASE)
#define BTL_FIRMWARE_LAST_ADDR				(FLASH_BASE | BTL_FIRMWARE_SIZE)

#define FLASH_LAST_ADDR						(FLASH_BASE | STM32F103C8Tx_FLASH_SIZE)
#define APP_FIRMWARE_LAST_ADDR				(FLASH_BASE | (FLASH_LAST_ADDR - APP_START_ADDR))

#define APP_FIRMWARE_SHA256_FEE_ADDR		(0x08007400)
